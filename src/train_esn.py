...
from src.config import DATA_RAW_PATH, MODEL_PATH,POLLUTANTS
import mlflow
import mlflow.sklearn

# trains on specefic feature in the pollutants list
def train_esn_pollutant(df, feature, forecast_horizon=6, n_reservoir=200, sparsity=0.2, spectral_radius=0.95):
        ...
        save_path = os.path.join(MODEL_PATH, f"esn_{feature.lower().replace('.', '')}.pkl")
